...
pushd "${original_project_dir}/debian-buster/iso" > /dev/null
  if [ ! -e "debian-10.6.0-amd64-xfce-CD-1.iso" ]; then
    jigdo-lite --noask https://cdimage.debian.org/mirror/cdimage/archive/10.6.0/amd64/jigdo-cd/debian-10.6.0-amd64-xfce-CD-1.jigdo
  fi
popd > /dev/null
